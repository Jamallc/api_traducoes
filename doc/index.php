...
</section></div><div class="middle"><section id="acesso" class="resource-group"><h2 class="group-heading">Acesso <a href="#acesso" class="permalink">&para;</a></h2></section></div><div class="middle"><div id="acesso-acesso_logout" class="resource"><h3 class="resource-heading">acesso_logout <a href="#acesso-acesso_logout" class="permalink">&para;</a></h3></div></div><div class="right"><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://localhost:8001/api_traducoes/</span>/acesso/acesso_logout.php</span></div><div class="tabs"><div class="tabs"><div class="example-names"><span>Responses</span><span class="tab-button">200</span><span class="tab-button">400</span><span class="tab-button">401</span><span class="tab-button">404</span></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div><div class="middle"><div id="acesso-acesso_logout-get" class="action get"><h4 class="action-heading"><div class="name">acesso_logout</div><a href="#acesso-acesso_logout-get" class="method get">GET</a><code class="uri">/acesso/acesso_logout.php</code></h4><p>Perde o acesso ao aplicativo interno e seu Token.</p>
<table>
<thead>
<tr>
<th>status</th>
...
<td><code>fail</code></td>
<td>-1</td>
<td>email já cadastrado por outro usuário</td>
</tr>
<tr>
<td><code>success</code></td>
<td>0</td>
...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>USUARIO_ID</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>123</span></span><p>ID.</p>
...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>PROJETO_NOME</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>Projeto delivery</span></span><p>Email.</p>
...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>PROJETO_ID</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>20</span></span><p>ID.</p>
...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>PROJETO_ID</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>20</span></span><p>Id do projeto.</p>
...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>LINGUA_NOME</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>Português</span></span><p>Idioma.</p>
...
</dd></dl></div></div></div><hr class="split"><div class="middle"><div id="lingua-lingua_editar" class="resource"><h3 class="resource-heading">lingua_editar <a href="#lingua-lingua_editar" class="permalink">&para;</a></h3></div></div><div class="right"><div class="definition"><span class="method put">PUT</span>&nbsp;<span class="uri"><span class="hostname">http://localhost:8001/api_traducoes/</span>/lingua/lingua_editar.php</span></div><div class="tabs"><div class="example-names"><span>Requests</span><span class="tab-button">lingua_editar</span></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
    ...
    "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"success"</span></span>,
    "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">message</span>": <span class="hljs-value"><span class="hljs-string">"língua salva com sucesso"</span></span>,
}</code></pre><div style="height: 1px;"></div></div></div></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-number">400</span></span>,
  "<span class="hljs-attribute">message</span>": <span class="hljs-value"><span class="hljs-string">"Bad request"</span>
</span>}</code></pre><div style="height: 1px;"></div></div></div></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
  ...
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-number">404</span></span>,
  "<span class="hljs-attribute">message</span>": <span class="hljs-value"><span class="hljs-string">"Not found"</span>
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div></div><div class="middle"><div id="lingua-lingua_editar-put" class="action put"><h4 class="action-heading"><div class="name">lingua_editar</div><a href="#lingua-lingua_editar-put" class="method put">PUT</a><code class="uri">/lingua/lingua_editar.php</code></h4><p>Edita uma língua.</p>
<table>
<thead>
<tr>
<th>status</th>
...
<td><code>success</code></td>
<td>0</td>
<td>língua salva com sucesso</td>
</tr>
</tbody>
</table>
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>LINGUA_ID</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>23</span></span><p>Id.</p>
</dd><dt>LINGUA_NOME</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>Português</span></span><p>Nome.</p>
</dd><dt>LINGUA_SIGLA</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>PT</span></span><p>Sigla.</p>
</dd><dt>Idioma</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>pt</span></span><p>Idioma.</p>
...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>TEXTO_FRASE</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>Uma nova frase</span></span><p>Frase da tradução.</p>
...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>TEXTO_FRASE</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>Uma outra frase</span></span><p>Frase da tradução.</p>
...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>TEXTO_ID</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>15</span></span><p>Id da frase.</p>
</dd><dt>Idioma</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>pt</span></span><p>Idioma.</p>
</dd></dl></div></div></div><hr class="split"><div class="middle"><section id="sync" class="resource-group"><h2 class="group-heading">Sync <a href="#sync" class="permalink">&para;</a></h2></section></div><div class="middle"><div id="sync-sync_projetos" class="resource"><h3 class="resource-heading">sync_projetos <a href="#sync-sync_projetos" class="permalink">&para;</a></h3></div></div><div class="right"><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://localhost:8001/api_traducoes/</span>/sync/sync_projetos.php</span></div><div class="tabs"><div class="example-names"><span>Requests</span><span class="tab-button">sync_projetos</span></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
    "<span class="hljs-attribute">Idioma</span>": <span class="hljs-value"><span class="hljs-string">"pt"</span></span>,
}</code></pre><div style="height: 1px;"></div></div></div><div class="tabs"><div class="example-names"><span>Responses</span><span class="tab-button">200</span><span class="tab-button">400</span><span class="tab-button">401</span><span class="tab-button">404</span></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
    <span class="hljs-string">"status"</span>: <span class="hljs-string">"success"</span>,
    <span class="hljs-string">"code"</span>: <span class="hljs-number">0</span>,
  ...
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-number">404</span></span>,
  "<span class="hljs-attribute">message</span>": <span class="hljs-value"><span class="hljs-string">"Not found"</span>
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div></div><div class="middle"><div id="sync-sync_projetos-get" class="action get"><h4 class="action-heading"><div class="name">sync_projetos</div><a href="#sync-sync_projetos-get" class="method get">GET</a><code class="uri">/sync/sync_projetos.php</code></h4><p>Retorna todos os projetos cadastrados.</p>
<table>
<thead>
<tr>
<th>status</th>
...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>Idioma</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>pt</span></span><p>Idioma.</p>
</dd></dl></div></div></div><hr class="split"><div class="middle"><div id="sync-sync_editores" class="resource"><h3 class="resource-heading">sync_editores <a href="#sync-sync_editores" class="permalink">&para;</a></h3></div></div><div class="right"><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://localhost:8001/api_traducoes/</span>/sync/sync_editores.php</span></div><div class="tabs"><div class="example-names"><span>Requests</span><span class="tab-button">sync_editores</span></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
    "<span class="hljs-attribute">PROJETO_ID</span>": <span class="hljs-value"><span class="hljs-string">"20"</span></span>,
    "<span class="hljs-attribute">Idioma</span>": <span class="hljs-value"><span class="hljs-string">"pt"</span></span>,
}</code></pre><div style="height: 1px;"></div></div></div><div class="tabs"><div class="example-names"><span>Responses</span><span class="tab-button">200</span><span class="tab-button">400</span><span class="tab-button">401</span><span class="tab-button">404</span></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
    <span class="hljs-string">"status"</span>: <span class="hljs-string">"success"</span>,
  ...
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-number">404</span></span>,
  "<span class="hljs-attribute">message</span>": <span class="hljs-value"><span class="hljs-string">"Not found"</span>
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div></div><div class="middle"><div id="sync-sync_editores-get" class="action get"><h4 class="action-heading"><div class="name">sync_editores</div><a href="#sync-sync_editores-get" class="method get">GET</a><code class="uri">/sync/sync_editores.php</code></h4><p>Retorna todos os editores cadastrados no projeto.</p>
<table>
<thead>
<tr>
<th>status</th>
...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>PROJETO_ID</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>20</span></span><p>Id do projeto.</p>
...
</dd></dl></div></div></div><hr class="split"><div class="middle"><div id="sync-sync_idiomas" class="resource"><h3 class="resource-heading">sync_idiomas <a href="#sync-sync_idiomas" class="permalink">&para;</a></h3></div></div><div class="right"><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://localhost:8001/api_traducoes/</span>/sync/sync_idiomas.php</span></div><div class="tabs"><div class="example-names"><span>Requests</span><span class="tab-button">sync_idiomas</span></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
    "<span class="hljs-attribute">PROJETO_ID</span>": <span class="hljs-value"><span class="hljs-string">"20"</span></span>,
    "<span class="hljs-attribute">Idioma</span>": <span class="hljs-value"><span class="hljs-string">"pt"</span></span>,
}</code></pre><div style="height: 1px;"></div></div></div><div class="tabs"><div class="example-names"><span>Responses</span><span class="tab-button">200</span><span class="tab-button">400</span><span class="tab-button">401</span><span class="tab-button">404</span></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
    <span class="hljs-string">"status"</span>: <span class="hljs-string">"success"</span>,
  ...
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-number">404</span></span>,
  "<span class="hljs-attribute">message</span>": <span class="hljs-value"><span class="hljs-string">"Not found"</span>
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div></div><div class="middle"><div id="sync-sync_idiomas-get" class="action get"><h4 class="action-heading"><div class="name">sync_idiomas</div><a href="#sync-sync_idiomas-get" class="method get">GET</a><code class="uri">/sync/sync_idiomas.php</code></h4><p>Retorna todos os idiomas cadastrados no projeto.</p>
<table>
<thead>
<tr>
<th>status</th>
...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>PROJETO_ID</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>20</span></span><p>Id do projeto.</p>
...
</dd></dl></div></div></div><hr class="split"><div class="middle"><div id="sync-sync_textos" class="resource"><h3 class="resource-heading">sync_textos <a href="#sync-sync_textos" class="permalink">&para;</a></h3></div></div><div class="right"><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://localhost:8001/api_traducoes/</span>/sync/sync_textos.php</span></div><div class="tabs"><div class="example-names"><span>Requests</span><span class="tab-button">sync_textos</span></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
    "<span class="hljs-attribute">LINGUA_ID</span>": <span class="hljs-value"><span class="hljs-string">"23"</span></span>,
    "<span class="hljs-attribute">Idioma</span>": <span class="hljs-value"><span class="hljs-string">"pt"</span></span>,
}</code></pre><div style="height: 1px;"></div></div></div><div class="tabs"><div class="example-names"><span>Responses</span><span class="tab-button">200</span><span class="tab-button">400</span><span class="tab-button">401</span><span class="tab-button">404</span></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
    <span class="hljs-string">"status"</span>: <span class="hljs-string">"success"</span>,
  ...
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-number">404</span></span>,
  "<span class="hljs-attribute">message</span>": <span class="hljs-value"><span class="hljs-string">"Not found"</span>
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div></div><div class="middle"><div id="sync-sync_textos-get" class="action get"><h4 class="action-heading"><div class="name">sync_textos</div><a href="#sync-sync_textos-get" class="method get">GET</a><code class="uri">/sync/sync_textos.php</code></h4><p>Retorna todas as frases cadastradas no idioma.</p>
<table>
<thead>
<tr>
<th>status</th>
...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>LINGUA_ID</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>23</span></span><p>Id da lingua.</p>
</dd><dt>Idioma</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>pt</span></span><p>Idioma.</p>
</dd></dl></div></div></div><hr class="split"><div class="middle"><div id="sync-sync_perfil" class="resource"><h3 class="resource-heading">sync_perfil <a href="#sync-sync_perfil" class="permalink">&para;</a></h3></div></div><div class="right"><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://localhost:8001/api_traducoes/</span>/sync/sync_perfil.php</span></div><div class="tabs"><div class="example-names"><span>Requests</span><span class="tab-button">sync_perfil</span></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
  ...
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-number">404</span></span>,
  "<span class="hljs-attribute">message</span>": <span class="hljs-value"><span class="hljs-string">"Not found"</span>
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div></div><div class="middle"><div id="sync-sync_perfil-get" class="action get"><h4 class="action-heading"><div class="name">sync_perfil</div><a href="#sync-sync_perfil-get" class="method get">GET</a><code class="uri">/sync/sync_perfil.php</code></h4><p>Retorna todos os editores cadastrados no projeto.</p>
<table>
<thead>
<tr>
<th>status</th>
...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>USUARIO_ID</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>20</span></span><p>Id do projeto.</p>
</dd><dt>Idioma</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>pt</span></span><p>Idioma.</p>
</dd></dl></div></div></div><hr class="split"><div class="middle"><p style="text-align: center;" class="text-muted">Generated by&nbsp;<a href="https://github.com/danielgtaylor/aglio" class="aglio">aglio</a>&nbsp;on 08 Sep 2022</p></div></div></div></div><script>/* eslint-env browser */
