...
<div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>USUARIO_EMAIL</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>teste@email.com</span></span><p>Email.</p>
...
</dd></dl></div></div></div><hr class="split"><div class="middle"><div id="usuário-usuario_editar_perfil" class="resource"><h3 class="resource-heading">usuario_editar_perfil <a href="#usuário-usuario_editar_perfil" class="permalink">&para;</a></h3></div></div><div class="right"><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname">http://localhost:8001/api_traducoes/</span>/usuarios/usuario_editar_perfil.php</span></div><div class="tabs"><div class="example-names"><span>Requests</span><span class="tab-button">usuario_editar_perfil</span></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
  ...
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-number">404</span></span>,
  "<span class="hljs-attribute">message</span>": <span class="hljs-value"><span class="hljs-string">"Not found"</span>
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div></div><div class="middle"><div id="usuário-usuario_editar_perfil-post" class="action post"><h4 class="action-heading"><div class="name">usuario_editar_perfil</div><a href="#usuário-usuario_editar_perfil-post" class="method post">POST</a><code class="uri">/usuarios/usuario_editar_perfil.php</code></h4><p>Edita o perfil do usuário.</p>
<table>
<thead>
<tr>
<th>status</th>
...
<ul>
<li>Parameters + PROJETO_NOME: <code>Projeto delivery</code> (required, string) - Email.
<ul>
<li>PROJETO_DESCRICAO: <code>Essa é a descrição do projeto delivery</code> (optional, string) - Email.</li>
<li>Idioma: <code>pt</code>(required, string) - Idioma.</li>
</ul>
</li>
</ul>
</div></div><hr class="split"><div class="middle"><div id="projeto-projeto_editar" class="resource"><h3 class="resource-heading">projeto_editar <a href="#projeto-projeto_editar" class="permalink">&para;</a></h3></div></div><div class="right"><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname">http://localhost:8001/api_traducoes/</span>/projeto/projeto_editar.php</span></div><div class="tabs"><div class="example-names"><span>Requests</span><span class="tab-button">projeto_editar</span></div><div class="tab"><div><div class="inner"><h5>Body</h5><pre><code>{
  ...
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-number">404</span></span>,
  "<span class="hljs-attribute">message</span>": <span class="hljs-value"><span class="hljs-string">"Not found"</span>
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div></div><div class="middle"><div id="projeto-projeto_editar-post" class="action post"><h4 class="action-heading"><div class="name">projeto_editar</div><a href="#projeto-projeto_editar-post" class="method post">POST</a><code class="uri">/projeto/projeto_editar.php</code></h4><p>Cadastra um novo projeto.</p>
<table>
<thead>
<tr>
<th>status</th>
...
</dd></dl></div></div></div><hr class="split"><div class="middle"><p style="text-align: center;" class="text-muted">Generated by&nbsp;<a href="https://github.com/danielgtaylor/aglio" class="aglio">aglio</a>&nbsp;on 05 Sep 2022</p></div></div></div></div><script>/* eslint-env browser */
